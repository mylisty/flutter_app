  ...
  GestureDetector buildButton(IconData icon, String label) {
    return GestureDetector(
     child: Column(
       ...
       children: <Widget>[//Icon(icon,color: Colors.lightGreen[600],),
    ...
    return new MaterialApp(
        ...
        home: new Scaffold(
            ...
            body: new Row(
              ...
              children: <Widget>[
                new Baseline(baseline: 45,
                    baselineType: TextBaseline.alphabetic,
                child: Text('AbGSLJFJLSdjlsj',
                style: new TextStyle(
                  fontSize: 23,
                  color: Colors.black
                ),),),
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        home: new Scaffold(
            ...
            body: new Container(
              height: 200,
              child: new AspectRatio(aspectRatio: 1.5, //宽高比例
                child: new Container(
                  color: Colors.greenAccent,
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        home: new Scaffold(
            ...
            body: new ConstrainedBox(constraints: const BoxConstraints(
              minHeight: 200
            ),
            child: Text('a'),)
        )
              ...
              child: new Stack(
                children: <Widget>[
                  ...
                  new Positioned(
                    top: 1.0,
                    left: 1.0,
                    child: Text('flutter',style: new TextStyle(
                      color: Colors.black,
                      fontSize: 23,
                    ),),
                  ),
                  new Offstage(
                    offstage: false,
                    child: new Container(
                      child: Text('visiable',style: new TextStyle(
                        color: Colors.black,
                        fontSize: 67,),
                    ),
                  )
        ...
        home: new Scaffold(
            ...
            body:new Container(
              ...
              child: new FittedBox(
                ...
                child: new Container(
                  color: Colors.greenAccent,
                  child: Text('缩放布局',style: new TextStyle( //style 无用
                    color: Colors.white,
                  ),),
                ),
              ),
            ...
            body: new Stack(
              children: <Widget>[
                new Align(
                  ...
                  child: new Image.asset('assets/images/ant_installment_icon.png'),
                ),
                new Align(
                  ...
                  children: <Widget>[
                    ...
                    new Expanded(
                      child: new Container(
                        ...
                        margin: const EdgeInsets.all(20),
                        child: new Image.asset('assets/images/card_package_icon.png'),
                      ),
                    ),
    ...
    return new MaterialApp(
      ...
      home: Scaffold(
        ...
        body: new Column(
          children: <Widget>[
           new Container(
             padding: const EdgeInsets.only(left: 20.0), // padding 用法  EdgeInsets.all上下左右20
             child: new Form(
               key: loginkey,
               child: new Column(
                 children: <Widget>[
          ...
          body: new Column(
            children: <Widget>[
              ...
              new RaisedButton(
                  ...
                  color: Colors.lightBlue,
                  child: Text("raisebutton",style: new TextStyle(color: Colors.black),),
                  )
            ],
          )
        )
...
class MyApp5 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        title: "ImageDemo",
        home: new Scaffold( //功能 示抽屉（drawers，比如：左边栏）、通知（snack bars） 以及 底部按钮（bottom sheets）。
          appBar: new AppBar(
            title: new Text('Text'),
          ),
          body: new Column(  //竖直排列
            children: <Widget>[
              new Text(
                '颜色+ 删除线条 + 25',
                style: new TextStyle(
        ...
        body: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: const BorderRadius.all(const Radius.circular(8)),//弧度
            ),
           child: Text(
             'FLUTTER',
